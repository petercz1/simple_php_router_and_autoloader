 ...
 */
 class Autoloader
 {
     // assumes all classes are nested in this folder. Adjust to taste.
     private $classes_folder = 'classes';
     ...
     private function recursivelyFindClasses(string $class): void
     {
         try {
			 ...
			 $files = new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($this->classes_folder, \RecursiveDirectoryIterator::SKIP_DOTS));
